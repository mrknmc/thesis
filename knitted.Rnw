...
Finally, I would like to thank Daniela Kellerova who made sure I do not go insane while working on this project.
\pagenumbering{Roman}
...
In this section we are going to discuss challenges we encountered while porting Apache Storm to multi-core machines. We also try to provide a critical analysis of the project.
