...
<<countbolt-plot, echo=FALSE, cache=FALSE, fig.cap="Tuples processed by CountBolt in Storm-MC and Apache Storm", fig.align="center", message=F, warning=F, fig.pos="!htb", fig.height=3.5>>=
@
...
<<enron-plot, echo=FALSE, cache=FALSE, fig.cap="Global Email Throughput over time. Standard error shown in light grey.", fig.align="center", fig.pos="!htb", fig.height=6.5>>=
@
